...
I happened to attend one of the data conferences few years back where I came to know the power of spark-sql. I have been working with relational databases and sql
...
-  Explain Plan/Query Execution Plan - The best way to make sure everything has run as expected is to look
   at the execution plan. You can see in the execution plan - dataframe_object.explain(),  the keywords InMemoryTableScan and 
