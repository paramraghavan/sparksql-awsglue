...
create glue metadata in glue catalog to map data in S3 - other wasy to create a using awswrangler package and using sql DDL. This S3 data can be accessed 
